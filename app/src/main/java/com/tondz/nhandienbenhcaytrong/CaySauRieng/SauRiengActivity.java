package com.tondz.nhandienbenhcaytrong.CaySauRieng;
...
public class SauRiengActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == SELECT_IMAGE && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                List<String> result = cayTrongSDK.predictSauRiengPath(imagePath);
    ...
    private String predict(List<String> result) {
        ...
        String label = Common.sauRiengs[idx];
        String chuaBenh = Common.chuaSauRieng[idx];
    ...
    private void reload() {
        boolean ret_init = cayTrongSDK.loadModel(getAssets(), 2);
        if (!ret_init) {
