...
public class CayNgoActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cay_ngo);
        init();
        reload();
        onClick();
    }
    ...
    private String predict(String result) {
        ...
        if (maxIdx == 3) {
            return Common.cayNgo[maxIdx] + " " + (int) (maxScore * 100) + "%";
        } else {
